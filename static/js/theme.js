  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (header) {
      ...
      function onScrollFrame(){
        ...
        // - you are near the very top, OR
        // - the menu is open, OR
        // - something inside the header has focus
        if (nearTop() || menuOpen() || focusInHeader()){
          header.classList.remove('is-hidden');
        }
        // HIDE header only when scrolling down enough and not near top
